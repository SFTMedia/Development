...
public class MessageManager {
	...
	static {
		...
		defaultMessages.put("console_jmodchat_prefix", "&2Global JMod Chat &f> &2");
		defaultMessages.put("console_modchat_prefix", "&9Global Mod Chat &f> &9");
		defaultMessages.put("console_manchat_prefix", "&4Global Manager Chat &f> &4");
		defaultMessages.put("console_adminchat_prefix", "&cGlobal Admin Chat &f> &c");
