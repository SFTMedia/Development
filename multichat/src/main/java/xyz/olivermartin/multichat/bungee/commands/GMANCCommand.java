 ...
 *
 */
public class GMANCCommand extends Command {

	private static String[] aliases = new String[] {};

	public GMANCCommand() {
		super("gmanc", "multichat.staff.manager", aliases);
	}
		...
		if (args.length != 2) {
			...
			if ((args[0].equals("a")) || (args[0].equals("b")) || (args[0].equals("c")) || (args[0].equals("d"))
				...
				if ((args[1].equals("a")) || (args[1].equals("b")) || (args[1].equals("c")) || (args[1].equals("d"))
					...
					MultiChat.managerchatpreferences.remove(player.getUniqueId());

					chatinfo.setChatColor(args[0].charAt(0));
					chatinfo.setNameColor(args[1].charAt(0));

					MultiChat.managerchatpreferences.put(player.getUniqueId(), chatinfo);

					MessageManager.sendMessage(sender, "command_gman_updated");
