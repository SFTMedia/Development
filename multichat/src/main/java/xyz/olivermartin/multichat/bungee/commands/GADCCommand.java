 ...
 *
 */
public class GADCCommand extends Command {

	// Command aliases
	private static String[] aliases = new String[] {};

	public GADCCommand() {
		super("gadc", "multichat.staff.admin", aliases);
	}
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if (args.length != 2) {
			...
			if ((sender instanceof ProxiedPlayer)) {
				MessageManager.sendMessage(sender, "command_gadc_usage");
			} else {
				MessageManager.sendMessage(sender, "command_gadc_only_players");
			}

		} else if ((sender instanceof ProxiedPlayer)) {

			DebugManager.log("[gadcCommand] Command sender is a player");
			...
			if ((args[0].equals("a")) || (args[0].equals("b")) || (args[0].equals("c")) || (args[0].equals("d"))
				...
				if ((args[1].equals("a")) || (args[1].equals("b")) || (args[1].equals("c")) || (args[1].equals("d"))
					...
					DebugManager.log("[gadcCommand] Colour codes are valid");
					...
					DebugManager.log("[gadcCommand] Preferences updated");

					MessageManager.sendMessage(sender, "command_gadc_updated");

				} else {

					MessageManager.sendMessage(sender, "command_gadc_invalid");
					MessageManager.sendMessage(sender, "command_gadc_invalid_usage");
